	...
	<nav>
		<div id="side_nav">
			<ul id="nav" class = "">
				...
				<li><a href="../external/authorization_input.cfm">Internal Auth Form</a></li>
				...
				<li><a href="agency.cfm">DAS</a></li>
				<li><a href="pm_list.cfm">PM LIST</a></li>
				<li><a href="cardno.cfm">Voyager</a></li>
				<li><a href="van_opr_lookup.cfm">Operator Search</a></li>
				<li><a href="van_score_lookup.cfm">Van Score</a></li>
				<li><a href="aesfuel.cfm">AES</a></li>				
				<li><a href="aes_transeval.cfm">AES Trans</a></li>
				<li><a href="../lobby_display/development_mp_corvallis.cfm">Display</a></li>
				<li><cfif len(getAuthUser())><a href="/auth/logout.php">Logout</a></cfif></li>
			</ul>
		</div>
	</nav>	
</div>
